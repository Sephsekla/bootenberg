...
import './blocks/column/column.js';

const { registerBlockCollection } = wp.blocks;

registerBlockCollection( 'bootenberg', {
    title: 'Bootenberg',
    icon: <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-bootstrap" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
